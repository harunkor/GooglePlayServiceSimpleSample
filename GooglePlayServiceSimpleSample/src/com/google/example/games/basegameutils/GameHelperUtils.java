...
class GameHelperUtils {
    ...
    private final static int[] RES_IDS = {
            R.string.common_google_play_services_invalid_account_text, R.string.common_google_play_services_network_error_title,
            R.string.common_google_play_services_network_error_text, R.string.common_google_play_services_invalid_account_text
    };
